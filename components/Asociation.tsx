            ...
            {/* Comunicados*/}
                <div className="flex flex-col gap-7 mt-10 max-w-screen justify-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        <Advertisement type={"Anuncio"} date={"8/03/2024"} title={"Reparación de cableado eléctrico"} description={"Se ha detectado un corto circuito en el cableado eléctrico de la calle 12, se solicita a los vecinos que eviten el uso de electrodomésticos de alto consumo."} img={"https://peru21.pe/resizer/BrHKBn__ZW7bqCsN2Uer1MeILBU=/980x0/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/IRZIYEPO7RHSLBPCJBSH5M5FR4.jpg"} />
                        <Advertisement type={"Alerta"} date={"4/02/2024"} title={"Invasión de mapaches"} description={"Vistos cerca a la manzana F y G, cuidado pueden tener rabia. culpable: Brenis "} img={"https://elcomercio.pe/resizer/k_DT1bk2YJORbCmKEylngi75PZo=/1200x1200/smart/filters:format(jpeg):quality(75)/arc-anglerfish-arc2-prod-elcomercio.s3.amazonaws.com/public/RXAAQMQSRVDIFCM2AW4ZVWV7OU.jpg"} />
                        <Advertisement type={"Alerta"} date={"3/02/2024"} title={"Robo de auto"} description={"Robo de auto en la avenida Santa Rosa, paradero 3"} img={"https://i.ytimg.com/vi/6Vo8jdRD3RM/hqdefault.jpg"} />
                    </div>
                </div>
            </div>
        </div>
